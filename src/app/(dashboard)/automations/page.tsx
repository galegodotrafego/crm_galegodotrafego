            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                <button
                  ...
                  className="group flex flex-col items-start rounded-xl border border-border surface-content p-4 text-left transition-colors hover:border-primary/50 glass-hover"
                >
